...
public class ViewCourseDto {
    ...
    public ViewCourseDto() {
    }

    public ViewCourseDto(long courseId, String courseName, String courseDescription, String courseDuration, String courseTiming, String courseStudentCount, String courseAcademicYear, String courseRequiredPercentage) {
